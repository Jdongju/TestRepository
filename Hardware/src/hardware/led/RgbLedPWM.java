...
public class RgbLedPWM {
	...
	public RgbLedPWM(Pin redPinNo, Pin greenPinNo, Pin bluePinNo) {
		GpioController gpioController = GpioFactory.getInstance();//Singleton. 생성될때 프로그램에서 하나만 생기도록
//		SW PWM출력 핀 객체 생성
		...
		//제어단계설정(255단계). 실제 단계와는 다를 수 있다. 실제 밝기조절단계와 제어단계가 일치하지 않으니까.
