...
//		발신시간을 start에 저장
	...
	public static void main(String[] args) throws InterruptedException {
		...
		UltrasonicSensor us4 = new UltrasonicSensor(RaspiPin.GPIO_00, RaspiPin.GPIO_02);
		...
		while (true) {
			...
			int distance3 = us3.getDistance();
			int distance4 = us4.getDistance();
			int distance5 = us5.getDistance();
			System.out.println("-----------------------------------");
			System.out.println("1: "+distance1);
			System.out.println("2: "+distance2);
			System.out.println("3: "+distance3);
			System.out.println("4: "+distance4);
			System.out.println("5: "+distance5);
			System.out.println("-----------------------------------");
