...
<html>
	...
	<body>
		...
		<p style="background-color:skyblue; border:1px solid black; height: 100px"> p태그</p>
		...
		<img style="border:1px solid black; " src="<%=application.getContextPath()%>/resources/image/marx.jpg" height="50px"/>
