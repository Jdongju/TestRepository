...
<html>
	...
	<body>
		...
		<h3>이미지 태그</h3>
		<img src="<%=application.getContextPath()%>/resources/image/marx.jpg" alt="Spring" width="200"/>
		<input type="image" src="<%=application.getContextPath()%>/resources/image/marx.jpg"/>
