		...
		<form method="post" style="pading: 0 20" enctype="multipart/form-data"> <%--멀티파트이면 메소드가 포스트여야만한다.--%>
			...
			<div class="form-group">
				<div class="input-group">
					...
					<%-- <img src="<%=application.getContextPath()%>/resources/image/member${board.bno}.png" width="100" height="100"/> --%>
<img src="<%=application.getContextPath()%>/resources/image/${board.boriginalfilename}" width="100" height="100"/>
				</div>
			</div>
			<div class="form-group">
				<div class="input-group">
