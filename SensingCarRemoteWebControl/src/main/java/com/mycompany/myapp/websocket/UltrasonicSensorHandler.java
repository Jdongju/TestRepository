...
@Component
public class UltrasonicSensorHandler extends TextWebSocketHandler implements ApplicationListener<ApplicationEvent> {
	...
	public void init() {
		...
		coapClient.setURI("coap://192.168.3.48:5683/ultrasonicsensor");
