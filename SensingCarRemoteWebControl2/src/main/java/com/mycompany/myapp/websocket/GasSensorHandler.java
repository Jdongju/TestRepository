...
@Component
public class GasSensorHandler extends TextWebSocketHandler implements ApplicationListener<ApplicationEvent> {
	...
	public void init() {
		...
		coapClient.setURI("coap://192.168.3.48:5683/gassensor");
		coapObserveRelation = coapClient.observe(new CoapHandler() {
			...
			public void onLoad(CoapResponse response) {
				...
				jsonObject.put("gassensor", gassensor);
