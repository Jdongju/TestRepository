...
@Component
public class fronttireHandler extends TextWebSocketHandler implements ApplicationListener<ApplicationEvent> {
	private static final Logger LOGGER = LoggerFactory.getLogger(fronttireHandler.class);
	...
	public void init() {
		...
		coapClient.setURI("coap://192.168.3.48:5683/fronttire");
