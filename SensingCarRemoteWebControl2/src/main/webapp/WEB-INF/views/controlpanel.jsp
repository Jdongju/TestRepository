					...
					<div class="row">
						...
						<div class="col-lg-5">
							<div style="background: linear-gradient(#737373, black); color: white; height:150px; background-color: lightgray; padding: 5px; margin-top: 20px;">
								...
								<div style="text-align: center">현재 상태: <span id="backtireStatus">direction=${direction}; speed=${speed} </span></div>
								<br/>
								<div style="text-align: center;">
									<button type="button" class="btn btn-warning" onclick="backtire('change', 'forward', '${speed}')" style="margin-bottom: 5px;">전진</button>
									<button type="button" class="btn btn-info" onclick="backtire('change', 'backward', '${speed}')" style="margin-bottom: 5px;">후진</button>
									<br/>
									<button id="btnSpeed0"  onclick="backtire('change', '${direction}', '0' )" style="color: black;">0</button>
									<button id="btnSpeed1" onclick="backtire('change','${direction}', '1')" style="color: black;">1</button>
									<button id="btnSpeed2" onclick="backtire('change','${direction}', '2')" style="color: black;">2</button>
									<button id="btnSpeed3" onclick="backtire('change','${direction}', '3')" style="color: black;">3</button>
									<button id="btnSpeed4" onclick="backtire('change','${direction}', '4')" style="color: black;">4</button>
									<button id="btnSpeed5" onclick="backtire('change','${direction}', '5')" style="color: black;">5</button>
									<button id="btnSpeed6" onclick="backtire('change','${direction}', '6')" style="color: black;">6</button>
									<button id="btnSpeed7" onclick="backtire('change','${direction}', '7')" style="color: black;">7</button>
									<button id="btnSpeed8" onclick="backtire('change','${direction}', '8')" style="color: black;">8</button>
									<button id="btnSpeed9" onclick="backtire('change','${direction}', '9')" style="color: black;">9</button>
									<button id="btnSpeed10" onclick="backtire('change','${direction}', '10')" style="color: black;">10</button>
								</div>                                      
							</div> 
						</div>
					</div>          
