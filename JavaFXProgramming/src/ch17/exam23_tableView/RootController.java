...
public class RootController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        list.add(new Phone("phone03.png","갤럭시s2","첫번째 모델입니다."));
        list.add(new Phone("phone04.png","갤럭시s2","첫번째 모델입니다."));
        list.add(new Phone("phone05.png","갤럭시s2","첫번째 모델입니다."));
        list.add(new Phone("phone06.png","갤럭시s2","첫번째 모델입니다."));
        tableView.setItems(list);
        
        tableView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Phone>() {
            @Override
            public void changed(ObservableValue<? extends Phone> observable, Phone oldValue, Phone newValue) {
                imageView.setImage(new Image(getClass().getResource("images/"+newValue.getImageName()).toString()));
            }
        });
    }
