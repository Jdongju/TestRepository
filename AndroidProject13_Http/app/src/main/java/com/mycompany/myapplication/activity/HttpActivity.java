...
public class HttpActivity extends AppCompatActivity {
    ...
    public void handleBtnGet(View v) throws IOException {
        String url="http://192.168.3.164:8080/IoTWebProgramming/http/exam03";
    ...
    private boolean checkPermission(){
        ...
        if (permissionRES != PackageManager.PERMISSION_GRANTED|| permissionWES != PackageManager.PERMISSION_GRANTED) {
    ...
    public void handleBtnAttach(View v) {
        if(checkPermission()) {
            ...
            startActivityForResult(Intent.createChooser(intent, "이미지선택"), 1);
        }
    }
    ...
    public void handleBtnMultipart(View v) {
        ...
        String url="http://192.168.3.164:8080/IoTWebProgramming/http/exam04";
    ...
    String url= "ws://192.168.3.164:8080/SensingCarRemoteWebControl/websocket/thermistorsensor";
        Request request= new Request.Builder()
                .url(url)
                .build();
        OkHttpClient client= new OkHttpClient();
...
//                        scrollView.scrollTo(0,scrollView.getHeight());
    ...
    public void handleBtnChangeAngle(View v){
        ...
        String url="http://192.168.3.164:8080/SensingCarRemoteWebControl/ultrasonicsensor";
        HttpUrl httpUrl= HttpUrl.parse(url).newBuilder()
