...
public class MainActivity extends AppCompatActivity {
    ...
    public void handleBtnFromAddressToLocation(View v) {
        ...
        HttpUrl httpUrl = HttpUrl.parse(url).newBuilder()
                ...
                .addQueryParameter("q","강원도 원주시 현충로58번길 29-1(태장동)")
    ...
    private void drawingPath(){
        if(polyline!=null){
            //path는 기존에 있던것 활용 못하고 한번에 다 그려야하기 떄문에 기존에 있던것을 지워준다.
            polyline.remove();
        }
    ...
    public void handleBtnCurrLcoationReturn(View v){
        listLocation.add(currLatLng);
        drawingPath();
    }
