...
<html>
	<head>
		...
		<script>
			function handleBtn1() {
				$.ajax({
					url: "/WebApplication/jquery/exam04_html_fragment", //url에서 받은 데이터는 function의 data로 들어온다.
			...
			function handleBtn2() {
				$.ajax({
					url: "/WebApplication/jquery/exam04_json", //url에서 받은 데이터는 function의 data로 들어온다.
					success: function (data) {
